...
namespace HWConsoleApp2 //Home Work Lesson 02 calculator
{
	class Program
	{
		static void Main(string[] args)
		{
			...
			string again = "да";
			while (again == "да") //the loop allows you to continue the calculation without leaving the program
			{
				Console.WriteLine("\n*************************");
				Console.WriteLine("\nВведите первое число и нажмите <ENTER>: ");
				double a = double.Parse(Console.ReadLine());

				Console.WriteLine("\nВведите математический оператор: <+> или <-> или <*> или </> или <^> или <%> и нажмите <ENTER>");
				...
				Console.WriteLine("Если хотите продолжить, наберите <да>, если хотите завершить, наберите <нет> и нажмите <ENTER>: ");
